...
credit_data<-read.table("D:\\R Programming\\R tutorial demo files\\R tutorial demo files\\Data files\\credit.txt")
View(credit_data)
...
salary <- read.csv("D:\\R Programming\\R tutorial demo files\\R tutorial demo files\\Data files\\Salaries.csv")
head(salary)
View(salary)
...
excel_sheets("D:\\R Programming\\R tutorial demo files\\R tutorial demo files\\Data files\\pokemon.xlsx")

# Read data from the sheets using read_excel
df <- read_excel("D:\\R Programming\\R tutorial demo files\\R tutorial demo files\\Data files\\pokemon.xlsx",sheet='Moves')
head(df)
View(df)
...
entire_workbook <- lapply(excel_sheets("D:\\R Programming\\R tutorial demo files\\R tutorial demo files\\Data files\\pokemon.xlsx"), 
                          read_excel, 
                          path = "D:\\R Programming\\R tutorial demo files\\R tutorial demo files\\Data files\\pokemon.xlsx")
